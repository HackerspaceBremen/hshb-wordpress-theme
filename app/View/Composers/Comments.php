...
class Comments extends Composer
{
    ...
    public function title(): string
    {
        return sprintf(
            ...
            _nx('%1$s Antwort auf &ldquo;%2$s&rdquo;', '%1$s Antworten auf &ldquo;%2$s&rdquo;', get_comments_number(), 'comments title', 'sage'),
            get_comments_number() === 1 ? _x('Eine', 'comments title', 'sage') : number_format_i18n(get_comments_number()),
            get_the_title()
        );
    }
    ...
    public function previous(): ?string
    {
        ...
        return get_previous_comments_link(
            __('&larr; Ältere Kommentare', 'sage')
        );
    }
    ...
    public function next(): ?string
    {
        ...
        return get_next_comments_link(
            __('Neuere Kommentare &rarr;', 'sage')
        );
    }
